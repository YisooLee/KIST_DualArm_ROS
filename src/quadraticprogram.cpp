...
void CQuadraticProgram::UpdateMinProblem(const MatrixCXd& H, const VectorCXd& g)
{
...
void CQuadraticProgram::UpdateSubjectToAx(const MatrixCXd& A, const VectorCXd& lbA, const VectorCXd& ubA)
{
...
void CQuadraticProgram::UpdateSubjectToX(const VectorCXd& lb, const VectorCXd& ub)
{
    for (int i = 0; i < _num_var; i++)
    {
        _lb(i) = lb(i);
